...
var btnYell = document.querySelector('.js-btn-yell');
var btnTrans = document.querySelector('.js-btn-trans');
btnYell.addEventListener('mouseenter', function () {
  if (!btnTrans.classList.contains('active')) {
    btnTrans.classList.add('active');
  }
});
btnYell.addEventListener('mouseleave', function () {
  if (btnTrans.classList.contains('active')) {
    btnTrans.classList.remove('active');
  }
});
btnTrans.addEventListener('mouseenter', function () {
  if (!btnYell.classList.contains('active')) {
    btnYell.classList.add('active');
  }
});
btnTrans.addEventListener('mouseleave', function () {
  if (btnYell.classList.contains('active')) {
